...
for (let i = 0; i < CO2Data.length; i++) {
  ...
  let val = CO2Data[i].CO2_emission
  sum += val;
   if (CO2Data[i].Reading_date >= 1992 && CO2Data[i].Reading_date < 2002){dec1.push(val)} 
    else if (CO2Data[i].Reading_date >= 2002 && CO2Data[i].Reading_date < 2012) {dec2.push(val)} 
    else if (CO2Data[i].Reading_date >= 2012 && CO2Data[i].Reading_date < 2022) {dec3.push(val)}}
 //console.log(dec3);
